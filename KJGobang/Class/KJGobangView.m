...
- (void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event {
    ...
    KJPoint *p = [[KJPoint alloc] initPointWith:h y:v];
    
    if ([self move1:p] == FALSE) {
    ...
    p = [KJAI geablog:self.places type:OccupyTypeAI];
...
- (BOOL)move1:(KJPoint *)p { // 向p点进行落子并绘制的方法
